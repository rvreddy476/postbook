...
const backgroundColors = [
  ...
  { id: 'violet', bg: 'bg-gradient-to-br from-violet-600 to-purple-500 text-white' },
  { id: 'ocean', bg: 'bg-gradient-to-br from-cyan-400 to-blue-600 text-white' },
  { id: 'sunset', bg: 'bg-gradient-to-br from-orange-500 to-amber-400 text-white' },
  { id: 'forest', bg: 'bg-gradient-to-br from-emerald-500 to-teal-600 text-white' },
  { id: 'aurora', bg: 'bg-gradient-to-br from-violet-500 via-cyan-400 to-teal-500 text-white' },
  { id: 'midnight', bg: 'bg-gradient-to-br from-indigo-600 to-slate-800 text-white' }, 
  { id: 'tropical', bg: 'bg-gradient-to-br from-cyan-500 via-teal-400 to-lime-400 text-white' },
];
...
export function CreatePost({ onPostCreated }: CreatePostProps) {
  ...
  return (
    <Card className="shadow-sm border overflow-hidden bg-white hover:shadow-md transition-shadow">
      <div className="p-4">
        <div className="flex gap-3 mb-4">
          <Avatar className="h-12 w-12 cursor-pointer border-2 border-border hover:border-foreground/30 transition-all">
            <AvatarFallback className="bg-foreground text-white font-semibold">{userInitials}</AvatarFallback>
          </Avatar>
