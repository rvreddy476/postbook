...
import { Heart, MessageCircle, Share2, Bookmark, MoreHorizontal, Smile, Image as ImageIcon, ThumbsUp, ThumbsDown, ChevronDown } from "lucide-react";
...
export function PostCard({ id, author, content, image, likes, comments, time, backgroundColor, feeling }: PostCardProps) {
  ...
  const handleAddComment = (e: React.FormEvent) => {
    ...
    setCommentList([
      ...commentList, 
      { id: Date.now(), name: "Sarah Jenkins", role: "Full Stack Developer", text: commentText, time: "Just now", avatar: womanAvatar, likes: 0 }
    ]);
    setCommentText("");
      ...
      <CardFooter className="p-3 flex flex-col gap-3 border-t border-border/50 bg-card/50">
        ...
        {showComments && (
          <div className="w-full pt-2 animate-in slide-in-from-top-2 duration-200">
            ...
            {/* Comments List */}
            <ScrollArea className="max-h-[300px] pr-4 -mr-4" ref={scrollRef}>
